...
# with coagulation
PN_all = np.loadtxt('PN_coag3.dat')
PM_all = np.loadtxt('PM_coag3.dat')
# with condensation
...
plt.plot(PN_dep_day5, height, label="Nucleation, Condensation, Coagulation sink & deposition", color='green')
...
plt.plot(PM_dep_day5, height, label="Nucleation, Condensation, Coagulation sink & deposition", color='green')
