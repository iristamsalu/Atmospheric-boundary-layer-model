...
subroutine chemistry_step(conc,time1,time2,O2_in,N2_in,M_in,H2O_in,TEMP_in,exp_coszen,F_veg_isoprene,F_veg_monoterpene)
  real(dp), intent(inout) :: conc(neq)
  real(dp), intent(in)    :: time1, time2, O2_in, N2_in, M_in, H2O_in, TEMP_in
  real(dp), intent(in)    :: exp_coszen, F_veg_isoprene, F_veg_monoterpene
  ...
  call calculate_k(exp_coszen, F_veg_isoprene, F_veg_monoterpene)
...
subroutine calculate_k(exp_coszen, F_veg_isoprene, F_veg_monoterpene)
