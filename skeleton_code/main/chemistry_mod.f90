...
subroutine chemistry_step(conc,time1,time2,O2_in,N2_in,M_in,H2O_in,TEMP_in,exp_coszen,F_veg_isoprene,F_veg_monoterpene,CS_H2SO4,CS_ELVOC)
  real(dp), intent(inout) :: conc(neq)
  real(dp), intent(in)    :: time1, time2, O2_in, N2_in, M_in, H2O_in, TEMP_in
  real(dp), intent(in)    :: exp_coszen, F_veg_isoprene, F_veg_monoterpene, CS_H2SO4, CS_ELVOC
  ...
  call calculate_k(exp_coszen, F_veg_isoprene, F_veg_monoterpene, CS_H2SO4, CS_ELVOC)
...
subroutine calculate_k(exp_coszen, F_veg_isoprene, F_veg_monoterpene, CS_H2SO4, CS_ELVOC)
   ...
   k_rate(30) = CS_H2SO4                                                                                          ! H2SO4 = H2SO4_P
   k_rate(31) = F_veg_monoterpene                                                                                 ! Emission rate of alpha-pinene
   k_rate(32) = F_veg_isoprene                                                                                    ! Emission rate of isoprene
   ...
   k_rate(36) = CS_ELVOC                                                                                          ! ELVOC = ELVOC_P
...
subroutine f_lsode(neq, time, conc, conc_dot)
  ...
  ! 13 = Isoprene
  conc_dot(13) = k_rate(32) - k_rate(35)*conc(13)*conc(1) - k_rate(9)*conc(3)*conc(13)
  ...
  ! 23 = Alpha-pinene
  conc_dot(23) = k_rate(31) - k_rate(33)*conc(23)*conc(3) - k_rate(34)*conc(23)*conc(1)
